...
<div class="container-fluid">
    <div class="confirm-card">
        ...
        <div class="summary-box">
            <div class="row">
                <div class="col-md-6"><span class="label">Burial Date:</span> <span class="value" id="burial_date"></span></div>
                <div class="col-md-6"><span class="label">Area Type:</span> <span class="value" id="area_type"></span></div>
            </div>
            <div><span class="label">Grave Type:</span> <span class="value" id="grave_type" name="grave_type"></span></div>
            <div><span class="label">Prefered Cemetery Section:</span> <span class="value" id="section_id" name="section_id"></span></div>
            <div><span class="label">Notes:</span> <span class="value" id="request_note" name="request_note"></span></div>
        </div>

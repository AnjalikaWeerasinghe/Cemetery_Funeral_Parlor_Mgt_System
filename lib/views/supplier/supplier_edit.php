        ...
        <div class="cem-header d-flex justify-content-between align-items-center">
            <div>
                <h4 class="fw-bold mb-1">
                    <i class="fa fa-user-plus me-2"></i>Update Supplier
                </h4>
                <p class="mb-0 opacity-75">Update supplier information</p>
            </div>
        ...
        <div class="card-body p-4">
            ...
            <form id="submit_form">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    <a href="admin.php?page=supplier" class="btn btn-outline-secondary">
                        Cancel
                    </a>

                    <button type="submit" class="btn btn-cem">
                        <i class="fa fa-save me-2"></i>Update Supplier
                    </button>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#submit_form").submit(function(e){
            ...
            $.ajax({
                url: "../routes/supplier/update_supplier_route.php",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                dataType: "text",
                beforeSend:function(){
                    $(".btn-cem").prop("disabled",true).html('<i class="fa fa-spinner fa-spin me-2"></i>Updating...');
                },
                ...
                complete:function(){
                    $(".btn-cem").prop("disabled",false).html('<i class="fa fa-save me-2"></i>Update Supplier');
                }
            });
        });

        ...
        <div class="cem-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <h4 class="fw-bold mb-1">
                    <i class="fa fa-user-pen me-2"></i>Update Member
                </h4>
                <p class="mb-0 opacity-75">
                    Update cemetery member information
                </p>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#submit_form").submit(function(e){
            ...
            $.ajax({
                url: "../routes/member/update_member_route.php",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                ...
                complete:function(){
                    $(".btn-cem").prop("disabled",false).html('<i class="fa fa-save me-2"></i>Update Member');
                }
            });
        });
